...
*(如果视频没能自动显示，你可以 [点击此处在 GitHub 网页上直接观看原始文件](https://github.com/TenureAI/PhD-Zero/blob/main/demos/phd_zero_demo_e2e_prompting_tricks_v0_0316_480p.mov)，或手动用 Issue/PR 拖拽区生成原生 GitHub 图床视频连接替换上方地址).*
