...
https://github.com/TenureAI/PhD-Zero/assets/demos/phd_zero_demo_e2e_prompting_tricks_v0_0316_480p.mov

*(If the video does not display automatically, you can watch it here: [Demo Video on GitHub](https://github.com/TenureAI/PhD-Zero/blob/main/demos/phd_zero_demo_e2e_prompting_tricks_v0_0316_480p.mov) or drag and drop the file into the issue/PR box to generate a native GitHub CDN link).*
